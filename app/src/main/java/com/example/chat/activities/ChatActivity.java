...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage(){
        if(!RegexRules.Empty.matcher(binding.inputMessage.getText().toString()).matches()){
            return;
        }
...
//                    showToast("Error: "+response.code());
    ...
    private void setListeners(){
        ...
        binding.imageInfo.setOnClickListener(v -> intentWithExtra(receiverUser));

        binding.textName.setOnClickListener(v -> intentWithExtra(receiverUser));
    }

    public void intentWithExtra(User user){
